...
dump:
	...
	${BIN}/svg-font-dump -c `pwd`/config.yml -f -i ./src/original/Entypo.svg -o ./src/svg/ -d diff.yml
	${BIN}/svg-font-dump -c `pwd`/config.yml -f -i ./src/original/EntypoSocial.svg -o ./src/svg/ -d diff.yml
